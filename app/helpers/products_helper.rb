...
module ProductsHelper
  ...
  def all_select_price_search_product
    [
      ...
      [t("products.filter.range_5_to_10"), Settings.range_5m_to_10m],
      [t("products.filter.range_10_to_20"), Settings.range_10m_to_20m],
      [t("products.filter.range_20_to_50"), Settings.range_20m_to_50m],
      [t("products.filter.range_50_to_100"), Settings.range_50m_to_100m]
    ]
  end
end
